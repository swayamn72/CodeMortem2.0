    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <p className="hero-subtitle">⚔️ 1v1 Algorithmic Combat</p>
          <h1 className="hero-title">
            <span className="highlight">Code</span> or be{" "}
            <span className="highlight">Coded.</span>
          </h1>
          <p className="hero-description">
            Queue up. Get matched. Race to solve 7 algorithmic challenges in 30
            minutes. Beat your opponent. Climb the ranks. The arena is waiting.
          </p>
      ...
      <section className="section" id="features">
        ...
        <p className="section-subtitle">
          Every feature designed to give you the ultimate 1v1 experience
        </p>
        ...
        <div className="features-grid">
          <div className="card feature-card">
            ...
            <p>
              Glicko-2 rating system matches you with equally skilled opponents.
          ...
          <div className="card feature-card">
            ...
            <p>
              Fresh, original problems generated by GPT-4o — sorted by
              difficulty from warm-up to brain-melter. Never see the same
              match twice.
            </p>
          </div>
          ...
          <div className="card feature-card">
            ...
            <p>
              Split-screen editor with Monaco (VS Code engine). See when your
              opponent solves a question. Every second counts.
            </p>
          </div>
        ...
        <div className="steps">
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                ...
                opponent within your rating range. Average wait: under 30 seconds.
              </p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              <h3>Code & Submit</h3>
              <p>
                Write your solution in the Monaco editor. Hit Run to test with custom
